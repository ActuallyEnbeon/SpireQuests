package spireQuests.quests.enbeon.vfx;
...
public class MonsterDivinityAuraEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    ...
    public MonsterDivinityAuraEffect(AbstractCreature target) {
        ...
        this.x = target.hb.cX + MathUtils.random(-AbstractDungeon.player.hb.width / 16.0F, AbstractDungeon.player.hb.width / 16.0F);
        this.y = target.hb.cY + MathUtils.random(-AbstractDungeon.player.hb.height / 16.0F, AbstractDungeon.player.hb.height / 12.0F);
